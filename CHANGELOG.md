...
* rename master branch to main ([#150](https://github.com/Fdawgs/ydh-logos/issues/150)) ([70c8d00](https://github.com/Fdawgs/ydh-logos/commit/70c8d000db71ec9b4bd5812c7ce4b00e4f9133bc))
...
* **automerge:** fix context ([5fa6cd2](https://github.com/Fdawgs/ydh-logos/commit/5fa6cd2a511413a683621982819d7c53e8ef9d58))
...
* **ci:** use `lts/*` for node setup in lint job ([738c741](https://github.com/Fdawgs/ydh-logos/commit/738c7410ec10789c40129374d39bcf3430747136))
...
* remove git credentials after checkout ([#123](https://github.com/Fdawgs/ydh-logos/issues/123)) ([f548616](https://github.com/Fdawgs/ydh-logos/commit/f5486167981bb715ee0add7bc5a625b4892d15d0))
...
* **dependabot:** increase `open-pull-requests-limit` from 5 to 20 ([e307026](https://github.com/Fdawgs/ydh-logos/commit/e30702639d1bf41a2d726c62cf34754c05ad6b38))
* **deps-dev:** add missing caret range for prettier ([d8204fe](https://github.com/Fdawgs/ydh-logos/commit/d8204fedca89ad0a7faf9cd0a6a58698d7bea09c))
* **deps-dev:** bump @commitlint/cli from 16.3.0 to 17.0.2 ([#127](https://github.com/Fdawgs/ydh-logos/issues/127)) ([3d033b5](https://github.com/Fdawgs/ydh-logos/commit/3d033b58c6b0a48b4b88759cc84699ee8951e576))
* **deps-dev:** bump @commitlint/config-conventional ([#125](https://github.com/Fdawgs/ydh-logos/issues/125)) ([aacc5ab](https://github.com/Fdawgs/ydh-logos/commit/aacc5aba1d47f6c0247980cc6f0456d641275755))
...
* **deps-dev:** bump husky from 7.0.4 to 8.0.1 ([#126](https://github.com/Fdawgs/ydh-logos/issues/126)) ([4af5ed1](https://github.com/Fdawgs/ydh-logos/commit/4af5ed1132f187e76d8ced636e317200cdbf85eb))
...
* **deps:** bump actions/dependency-review-action from 1 to 2 ([#129](https://github.com/Fdawgs/ydh-logos/issues/129)) ([4b74f2f](https://github.com/Fdawgs/ydh-logos/commit/4b74f2fe4ad05b68966ec8b7a127f5a99a69dc34))
...
* **deps:** bump peter-evans/create-pull-request from 4.0.2 to 4.0.3 ([#124](https://github.com/Fdawgs/ydh-logos/issues/124)) ([50dec52](https://github.com/Fdawgs/ydh-logos/commit/50dec52dce68922f6d8c7c164e2f5242be0f69b9))
* **deps:** bump peter-evans/create-pull-request from 4.0.3 to 4.0.4 ([#130](https://github.com/Fdawgs/ydh-logos/issues/130)) ([0553d5a](https://github.com/Fdawgs/ydh-logos/commit/0553d5a7c89448f6a1a07ae445e63134452e457c))
* **deps:** bump wagoid/commitlint-github-action from 4 to 5 ([#128](https://github.com/Fdawgs/ydh-logos/issues/128)) ([8666c7c](https://github.com/Fdawgs/ydh-logos/commit/8666c7c16d16d957d5986cae1f0343d1c2e04a7c))

### Miscellaneous

* **.\*ignore:** add pnpm lockfile ([a010eec](https://github.com/Fdawgs/ydh-logos/commit/a010eec49871c343556c1c95e2dc634d5edffabf))
* **.github/funding:** remove comments ([f3f7ecb](https://github.com/Fdawgs/ydh-logos/commit/f3f7ecb7424062307e5955610f84950bbd92e3e5))
...
* **.github:** add `FUNDING.yml` ([f398185](https://github.com/Fdawgs/ydh-logos/commit/f39818588dc1ad988e7db7c0fe2250f0135b2c4d))
* **.gitignore:** use latest github ignore template ([dc0e95d](https://github.com/Fdawgs/ydh-logos/commit/dc0e95ddd6f6f91fdae592e729734d522f3060d0))
* **.prettierignore:** add new paths from `.gitignore` ([770be50](https://github.com/Fdawgs/ydh-logos/commit/770be50ce6365ecda541b532685458b06f5e9a81))
* **bug_report:** use node 18 as placeholder for `node-version` ([e230471](https://github.com/Fdawgs/ydh-logos/commit/e230471b1f27269d96ac762e87825e50b9b7cb72))
...
* **images:** compress images ([#131](https://github.com/Fdawgs/ydh-logos/issues/131)) ([fef53f4](https://github.com/Fdawgs/ydh-logos/commit/fef53f49907b8b3a19a2a3cc2b1e278139722ae4))
...
* bump coc from v2.0.0 to v2.1.0 ([#70](https://github.com/Fdawgs/ydh-logos/issues/70)) ([768b40c](https://github.com/Fdawgs/ydh-logos/commit/768b40c122a870db45ecb4ae8fdb3b96f1309549))
* **readme:** add link to hospital logo ([4120fee](https://github.com/Fdawgs/ydh-logos/commit/4120feef90e97802f38979049595e8128db602fa))

### Dependencies

* **deps-dev:** bump @commitlint/cli from 13.2.1 to 14.1.0 ([910eea8](https://github.com/Fdawgs/ydh-logos/commit/910eea8e262f01e1ac1d6f22af285ada2b545b28))
* **deps-dev:** bump @commitlint/config-conventional ([07e8644](https://github.com/Fdawgs/ydh-logos/commit/07e8644a8b024998df85dc5eb15e98ad71971652))
* **deps-dev:** bump dev dependencies ([05fa535](https://github.com/Fdawgs/ydh-logos/commit/05fa5353b00202a4f1b759114f44a48bf9ed536b))
* **deps-dev:** bump prettier from 2.3.2 to 2.4.1 ([4db83aa](https://github.com/Fdawgs/ydh-logos/commit/4db83aa9bde9dc2860eb065eb09ae46c21387761))
* **deps:** bump actions/checkout from 2.3.4 to 2.3.5 ([dbe22d8](https://github.com/Fdawgs/ydh-logos/commit/dbe22d89c3eec29a460e070e6e9f74db94e5c38f))
* **deps:** bump actions/checkout from 2.3.5 to 2.4.0 ([05d9b24](https://github.com/Fdawgs/ydh-logos/commit/05d9b245a83b63b77254d7d20f5ec5c92ae4cede))
* **deps:** bump actions/setup-node from 2.4.0 to 2.4.1 ([64aadab](https://github.com/Fdawgs/ydh-logos/commit/64aadab9e3fe106c348e141a4fb5437d56da800f))
* **deps:** bump GoogleCloudPlatform/release-please-action ([5841ac4](https://github.com/Fdawgs/ydh-logos/commit/5841ac4c5c809fb363ac2b76f571e5e7cb6fc263))
* **deps:** bump GoogleCloudPlatform/release-please-action ([7867668](https://github.com/Fdawgs/ydh-logos/commit/7867668c6485ad2b827d50e947025d108c57f1af))
* **deps:** bump wagoid/commitlint-github-action from 4.1.1 to 4.1.5 ([5cdbd13](https://github.com/Fdawgs/ydh-logos/commit/5cdbd1322c613a74443239ddda4300b8e239e9f6))
* **deps:** bump wagoid/commitlint-github-action from 4.1.5 to 4.1.9 ([3b380fd](https://github.com/Fdawgs/ydh-logos/commit/3b380fd27f47dfe9eec3f44da74eb3d3ebdb3370))

### Miscellaneous

* **.husky/.gitignore:** remove now redundant file ([72a790a](https://github.com/Fdawgs/ydh-logos/commit/72a790abd9a3754c8247487d35282aa5f9e3885d))
* **.prettierrc:** enable `bracketsameline` option ([b917a76](https://github.com/Fdawgs/ydh-logos/commit/b917a76af5f67c1cb54452cb557cfa3de739a149))
* **.prettierrc:** only enable `bracketsameline` for html ([476f04d](https://github.com/Fdawgs/ydh-logos/commit/476f04dd4ddce29c5239735d15c23e84f2850539))
* **.prettierrc:** override defaults for html, css, and scss files ([#62](https://github.com/Fdawgs/ydh-logos/issues/62)) ([ece0af5](https://github.com/Fdawgs/ydh-logos/commit/ece0af55efb0746149eeae77ff63ba6f6429f23a))
* **.vscode:** add `mhutchie.git-graph` extension ([7a590fa](https://github.com/Fdawgs/ydh-logos/commit/7a590fae9a84f67c2822e8226fa19834e5ce3a4d))
* **.vscode:** remove deprecated settings ([#69](https://github.com/Fdawgs/ydh-logos/issues/69)) ([78a253e](https://github.com/Fdawgs/ydh-logos/commit/78a253eb0b1926041e656ff2cacbf9e490f0604d))

### [2.2.1](https://github.com/Fdawgs/ydh-logos/compare/v2.2.0...v2.2.1) (2021-09-06)
...
* **optimise-images:** retain image quality ([#60](https://github.com/Fdawgs/ydh-logos/issues/60)) ([97d704f](https://github.com/Fdawgs/ydh-logos/commit/97d704f24e0b43b848f77331eb52a23f81c1bd4a))

### Miscellaneous

* **.github:** use new YAML configured GitHub issue forms ([#57](https://github.com/Fdawgs/ydh-logos/issues/57)) ([b2a330a](https://github.com/Fdawgs/ydh-logos/commit/b2a330aa71626fee9990ff547ccb6825a2ca4b24))
* **images/favicons:** lint svg safari logo ([f76318b](https://github.com/Fdawgs/ydh-logos/commit/f76318b3742533044ac8d0f47404f440aba57ffa))

## [2.2.0](https://github.com/Fdawgs/ydh-logos/compare/v2.1.0...v2.2.0) (2021-09-02)

### Features

* **images:** add favicons of coloured y logo ([#55](https://github.com/Fdawgs/ydh-logos/issues/55)) ([31a497e](https://github.com/Fdawgs/ydh-logos/commit/31a497ef7c9de60b5741b1f725036a4f591a251e))
...
* **deps-dev:** bump @commitlint/cli from 12.1.4 to 13.1.0 ([0569c29](https://github.com/Fdawgs/ydh-logos/commit/0569c297cc477ed42ef10f0b90b2c586c5aa42f5))
* **deps-dev:** bump @commitlint/config-conventional ([c44f35a](https://github.com/Fdawgs/ydh-logos/commit/c44f35a52c14e0322defdd769a5fbc2d0575c17b))
* **deps-dev:** bump @prettier/plugin-xml from 0.13.1 to 1.0.2 ([d39becb](https://github.com/Fdawgs/ydh-logos/commit/d39becb4e77f2669fbec46f8314ec0187fa96704))
* **deps:** bump actions/github-script from 4.0.2 to 4.1 ([fdb8473](https://github.com/Fdawgs/ydh-logos/commit/fdb84731376384caf747b060d7b993d8ab30d181))
* **deps:** bump actions/setup-node from 2.2.0 to 2.3.0 ([6dc99e9](https://github.com/Fdawgs/ydh-logos/commit/6dc99e92807c42cae58449d6f0771e7a96c7b417))
* **deps:** bump actions/setup-node from 2.3.0 to 2.4.0 ([0b9ed83](https://github.com/Fdawgs/ydh-logos/commit/0b9ed8392ebe0577aa9bd02c783ceb76a790750b))
* **deps:** bump GoogleCloudPlatform/release-please-action ([e6831fd](https://github.com/Fdawgs/ydh-logos/commit/e6831fd528d83ec026332b26b76ef863278b59a9))
* **deps:** bump peter-evans/create-pull-request from 3.10.0 to 3.10.1 ([7be378c](https://github.com/Fdawgs/ydh-logos/commit/7be378c20ade5e55a209c024d86b95d813f84b07))
* **deps:** bump wagoid/commitlint-github-action from 3.1.4 to 4.1.1 ([1dc5e51](https://github.com/Fdawgs/ydh-logos/commit/1dc5e51445ecd026be690c5a3ad2914ec2086dd9))

## [2.1.0](https://github.com/Fdawgs/ydh-logos/compare/v2.0.0...v2.1.0) (2021-07-08)
...
* **link-check:** reduce frequency from daily to monthly ([#38](https://github.com/Fdawgs/ydh-logos/issues/38)) ([d3c6991](https://github.com/Fdawgs/ydh-logos/commit/d3c69911431d75cea06c89af6059446327ae78d0))

### Dependencies

* **deps-dev:** bump husky from 6.0.0 to 7.0.0 ([b545406](https://github.com/Fdawgs/ydh-logos/commit/b54540648e3e4930024fa8dd02ef3400b9a44bfe))
* **deps-dev:** bump prettier from 2.2.1 to 2.3.0 ([4fb0230](https://github.com/Fdawgs/ydh-logos/commit/4fb0230db0eb65275aa4cab0b3f9b82f4160274f))
* **deps-dev:** bump prettier from 2.3.0 to 2.3.2 ([552f8b4](https://github.com/Fdawgs/ydh-logos/commit/552f8b4a268bade49eac46f136a19056efabbe1e))
* **deps:** bump actions/setup-node from 2.1.5 to 2.2.0 ([a50ad27](https://github.com/Fdawgs/ydh-logos/commit/a50ad2718030e1c98bbadd2999aedd4ea747e23f))
* **deps:** bump actions/upload-artifact from 2.2.3 to 2.2.4 ([99c50cd](https://github.com/Fdawgs/ydh-logos/commit/99c50cd8869322225c3d203b2159e76ba6ce8852))
* **deps:** bump GoogleCloudPlatform/release-please-action ([fa3eec2](https://github.com/Fdawgs/ydh-logos/commit/fa3eec2b054c02e8405583c4d76ca9c03b859de6))
* **deps:** bump peter-evans/create-pull-request from 3.8.2 to 3.10.0 ([942cabd](https://github.com/Fdawgs/ydh-logos/commit/942cabdf2142150b5f43f02399ce4184ec9a3dd9))
* **deps:** bump wagoid/commitlint-github-action from 3.1.0 to 3.1.4 ([baa1785](https://github.com/Fdawgs/ydh-logos/commit/baa178590b56b02bfb98c81454f838421b7ed3a8))

### Miscellaneous

* **ci:** replace `node-version` key with shorter `node` ([#32](https://github.com/Fdawgs/ydh-logos/issues/32)) ([229262b](https://github.com/Fdawgs/ydh-logos/commit/229262b8478bd3ad06a6da8692d7c1eda58dd56c))
* **vscode:** disable redhat telemetry ([679475e](https://github.com/Fdawgs/ydh-logos/commit/679475e0ff9903de1d12fc6df97a2173aa6a1d8e))
* **workflows:** remove `stale.yml` ([4db8db9](https://github.com/Fdawgs/ydh-logos/commit/4db8db9d36f96fc790787863488fd2ba2578b109))

## [2.0.0](https://github.com/Fdawgs/ydh-logos/compare/v1.1.0...v2.0.0) (2021-04-30)
...
* grammar and readability fixes ([b42fce8](https://github.com/Fdawgs/ydh-logos/commit/b42fce8db4d5ad2be6356cf853189bc35c27f8cb))
* **readme:** use head for image ([81234b5](https://github.com/Fdawgs/ydh-logos/commit/81234b5a86ce20141c5d3d9eae4bc53b517f9626))

### Dependencies

* **deps:** bump actions/github-script from v3.1.0 to v3.1.1 ([67e6bf6](https://github.com/Fdawgs/ydh-logos/commit/67e6bf6ed94ddd611770c169c16e71728c469c72))
* **deps:** bump actions/github-script from v3.1.1 to v4.0.2 ([8c42c82](https://github.com/Fdawgs/ydh-logos/commit/8c42c82489e8241fcb057c24c21c653d8fbdefc8))
* **deps:** bump actions/upload-artifact from v2.2.2 to v2.2.3 ([880100b](https://github.com/Fdawgs/ydh-logos/commit/880100b5a9e52ced098d1c285c2af1f29aa737ea))
* **deps:** bump GoogleCloudPlatform/release-please-action ([816e7e4](https://github.com/Fdawgs/ydh-logos/commit/816e7e409b4937fba7d97b896fbb9d5ea03efb41))
* **deps:** bump typoci/spellcheck-action from v0.3.0 to v0.4.0 ([3605f3b](https://github.com/Fdawgs/ydh-logos/commit/3605f3b00da76eceafb67f534adfd72ff3a8a97c))
* **deps:** bump typoci/spellcheck-action from v0.4.0 to v1.1.0 ([e2219aa](https://github.com/Fdawgs/ydh-logos/commit/e2219aa32f3677504ccd3d560ccfa6f49f1758db))
* **deps:** bump wagoid/commitlint-github-action from v3.0.6 to v3.1.0 ([931d627](https://github.com/Fdawgs/ydh-logos/commit/931d627d70dc49bd227b1537a6ccec580c25a8b1))

## [1.1.0](https://github.com/Fdawgs/ydh-logos/compare/v1.0.1...v1.1.0) (2021-03-29)

### Features

* **images:** add svg copies of logos ([0c0b2fc](https://github.com/Fdawgs/ydh-logos/commit/0c0b2fcc28ade7228b5ab4691011ce82e2097d49))
...
* **stale:** shorten workflow name ([dfaf9c5](https://github.com/Fdawgs/ydh-logos/commit/dfaf9c5e6b8b23a826e63c7ac7e55f3a77c3f497))

### Dependencies

* **deps-dev:** bump husky from 4.3.8 to 6.0.0 ([8538d58](https://github.com/Fdawgs/ydh-logos/commit/8538d587382de48bfdcf8e96b04eb7be028abda2))
* **deps-dev:** update husky config ([c0d642f](https://github.com/Fdawgs/ydh-logos/commit/c0d642fea87616f42a18da741fe50bde7da92688))
* **deps:** bump GoogleCloudPlatform/release-please-action ([8e32be9](https://github.com/Fdawgs/ydh-logos/commit/8e32be9d1fe081cef4cb3978a67075d16c96f902))
* **deps:** bump typoci/spellcheck-action from v0.3.0 to v0.4.0 ([b31428d](https://github.com/Fdawgs/ydh-logos/commit/b31428dbf9129674eddb13b9e899b894557c9b77))

### Documentation

* **readme:** add logo ([376728a](https://github.com/Fdawgs/ydh-logos/commit/376728af32f81fd6857d2b058c47fa193ac8ae63))

### [1.0.1](https://github.com/Fdawgs/ydh-logos/compare/v1.0.0...v1.0.1) (2021-03-18)

### Dependencies

* **deps:** bump actions/stale from v3.0.17 to v3.0.18 ([e47db73](https://github.com/Fdawgs/ydh-logos/commit/e47db73d309571ba039c4c812ca29d04d7f7175e))
* **deps:** bump fastify/github-action-merge-dependabot ([00a12e9](https://github.com/Fdawgs/ydh-logos/commit/00a12e95b933bfb4cd83a9d3ebea3186b7307442))
...
* auto-compress images ([b8a1e61](https://github.com/Fdawgs/ydh-logos/commit/b8a1e611bce5178455b6d6d7a7aab90d1d859b60))
* **package:** remove `npm test` script ([86255bc](https://github.com/Fdawgs/ydh-logos/commit/86255bc680b71dd5e41a7339958ae1c8f293f111))
* **vscode:** add recommended settings ([36c36cd](https://github.com/Fdawgs/ydh-logos/commit/36c36cdd672f24987eb0921898eceb453b3a45e8))
